...
std::list<std::uint64_t> merge_ml_rc(std::list<std::uint64_t> arg1, std::list<std::uint64_t> arg2) {
    ...
    if (x <= y) {
        ...
        auto temp4 = merge_ml_rc(std::move(temp1), std::move(temp2));
        temp4.push_front(x);
        ...
        auto temp8 = merge_ml_rc(std::move(temp5), std::move(temp7));
        temp8.push_front(y);
...
std::list<std::uint64_t> merge_sort_ml_rc(std::list<std::uint64_t> arg1) {
    ...
    auto temp0 = merge_sort_ml_rc(std::move(temp1));
    ...
    auto temp2 = merge_sort_ml_rc(std::move(temp3));
    return merge_ml_rc(std::move(temp0), std::move(temp2));
}
