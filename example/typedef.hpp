...
class stree {
    ...
    std::variant<_tNode, _Node, _lNode, _nNode, _sbool, _nat> value_;
    stree(const std::variant<_tNode, _Node, _lNode, _nNode, _sbool, _nat> &value) : value_(value) {}
...
class it_type {
    ...
    std::variant<_Constructor1, _Constructor2> value_;
    it_type(const std::variant<_Constructor1, _Constructor2> &value) : value_(value) {}

  public:
    it_type() = default;

    static it_type<T1, T2> Constructor1(const T2 &p1) {
        return it_type<T1, T2> { _Constructor1 { p1 } };
    }
    static it_type<T1, T2> Constructor2(const T2 &p1, const list<T1> &p2) {
        return it_type<T1, T2> { _Constructor2 { p1, p2 } };
    }
    ...
    bool operator<(const it_type<T1, T2> &rhs) const { return value_ < rhs.value_; }
};
