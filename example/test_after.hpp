...
template<typename T1>
std::list<T1> copyList(std::list<T1> arg1) {
    // copyList sNil = sNil
    if (arg1.empty()) {
        return std::list<T1>();
    }
...
template<typename T1>
std::list<T1> AddListIs(std::uint64_t arg1, T1 arg2, std::list<T1> arg3) {
...
template<typename T1>
std::list<T1> DelListIs(std::uint64_t arg1, std::list<T1> arg2) {
