...
void
TypeInference::map_dtypedef_cons(DatatypeDef& dtypedef)
{
...
void
TypeInference::map_funcdef_type(FunctionDef& funcdef)
{
  the_func_type_mapping.emplace(funcdef.name, ref(funcdef));
}

void
TypeInference::map_srtdef_type(ShortDef& srtdef)
{
  // todo...
}
} // namespace hol2cpp
