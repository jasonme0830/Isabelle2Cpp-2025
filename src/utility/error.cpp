...
string
light_red(const string& str)
{
  return "\033[1;31m" + str + "\033[0m";
}

string
light_blue(const string& str)
{
  return "\033[1;34m" + str + "\033[0m";
}

string
light_green(const string& str)
{
...
const char*
TokenizeError::what() const noexcept
{
  return err_.c_str();
}
...
const char*
CodegenError::what() const noexcept
{
  return err_.c_str();
}
} // namespace hol2cpp
